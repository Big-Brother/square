...
Only requiring some minor changes is square.cpp.
...
Changes to square.cpp
----------------------
square.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
