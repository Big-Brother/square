...
This mechanism has been integrated into Bitcore-Node-Square which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/squarepay/insight-api-square#web-socket-api](https://github.com/squarepay/insight-api-square#web-socket-api)
* API: [https://github.com/squarepay/insight-api-square#instantsend-transactions](https://github.com/squarepay/insight-api-square#instantsend-transactions)
...
By default, the Square Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Square Core daemon:
