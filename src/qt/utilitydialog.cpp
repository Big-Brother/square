    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Square Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Square Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  square-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Square in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SQUARE, 0.1 SQUARE, 1 SQUARE and 10 SQUARE -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://squarepay.atlassian.net/wiki/display/DOC/PrivateSend\">https://squarepay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Square Core is shutting down...") + "<br /><br />" +
