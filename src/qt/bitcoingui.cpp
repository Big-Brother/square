    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Square Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Square address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and square: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Square Core"), this);
    aboutAction->setStatusTip(tr("Show information about Square Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Square Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Square addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Square addresses"));
    ...
    openAction->setStatusTip(tr("Open a square: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Square Core help message to get a list with possible Square Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Square Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Square network", "", count));
    } else {
...
{
    QString strTitle = tr("Square Core"); // default title
