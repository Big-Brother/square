    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SQUARE-light"), QVariant("light"));
    ui->theme->addItem(QString("SQUARE-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("SQUARE-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SQUARE-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SQUARE-traditional"), QVariant("trad"));
