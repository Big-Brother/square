...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SquareNetwork") type = SquareNetwork;
    if(strType == "SquareNetworkVariable") type = SquareNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SquareNetwork) s = "SquareNetwork";
    if(type == SquareNetworkVariable) s = "SquareNetworkVariable";
