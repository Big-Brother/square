 ...
 *
 *   // network
 *   CSquareNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.square.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSquareNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: SquareNetwork
// //   -- signature requirements : Key1(User)
// class CSquareNetworkVariable : public CGovernanceObject
// {
// private:
